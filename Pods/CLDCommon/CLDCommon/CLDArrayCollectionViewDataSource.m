...
@implementation CLDArrayCollectionViewDataSource

+ (CLDArrayCollectionViewDataSource *)dataSourceWithArray:(NSArray *)array
...
{
    CLDArrayCollectionViewDataSource *dataSource = [[CLDArrayCollectionViewDataSource alloc] init];
