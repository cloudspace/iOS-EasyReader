...
// Background
- (BOOL)      cellHasGradientBackground        { return NO; }
- (UIColor *) cellBackgroundColor              { return [UIColor colorWithRed:51/255.0 green:84/255.0 blue:74/255.0 alpha:1.0]; }
//- (UIColor *) cellBackgroundTopColor           { return [UIColor colorWithRed:51/255.0 green:84/255.0 blue:74/255.0 alpha:1.0]; }
//- (UIColor *) cellBackgroundBottomColor        { return [UIColor colorWithRed:51/255.0 green:84/255.0 blue:74/255.0 alpha:1.0]; }
