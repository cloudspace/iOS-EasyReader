//
//  CSStyledTableViewHeaderFooterView.h
//  EasyReader
//
...
@interface CSStyledTableViewHeaderFooterView : UITableViewHeaderFooterView


#pragma mark - IBOutlet Properties
@property (nonatomic, retain) CSStyledTableViewStyle *tableViewStyle;
